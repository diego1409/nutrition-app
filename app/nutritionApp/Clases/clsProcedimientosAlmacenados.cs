...
namespace nutritionApp.Clases
{
    public class clsProcedimientosAlmacenados
    {
        ...
        public bool InsertaUsuario(Usuario usuario)
        {
            ...
            inserta.anadirParametroSP("@InputParm", usuario._Nombre, 2);
            inserta.anadirParametroSP("@InputParm", usuario._Apellido1, 2);
            inserta.anadirParametroSP("@InputParm", usuario._Apellido2, 2);
            inserta.anadirParametroSP("@InputParm", usuario._Direccion, 2);
            inserta.anadirParametroSP("@InputParm", usuario._Telefono1, 2);
            inserta.anadirParametroSP("@InputParm", usuario._Estatura, 1);
            inserta.anadirParametroSP("@InputParm", usuario._Peso, 3);
            inserta.anadirParametroSP("@InputParm", usuario._Proposito, 2);
            inserta.anadirParametroSP("@InputParm", usuario._Correo, 2);
            inserta.anadirParametroSP("@InputParm", usuario._NomUsuario, 2);
            inserta.anadirParametroSP("@InputParm", usuario._Contrasena, 2);
            inserta.anadirParametroSP("@InputParm", usuario._TipoUsuario, 2);

            return inserta.ejecutarSP();
            /*
