<%@ Page Title="Modificar Usuario" Language="C#" MasterPageFile="~/src/aspx/masterPageAdmin.Master" AutoEventWireup="true" CodeBehind="frmModificaUsuario.aspx.cs" Inherits="nutritionApp.src.aspx.frmModificaUsuario" %>
            ...
            <div class="col">
                        ...
                        <div class="form-row mb-3">
                            <div class="col">
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- Contraseña -->
                                    <asp:TextBox ID="txtContrasena" class="form-control" runat="server" Width="250px" MaxLength="50" ReadOnly="false" TextMode="Password"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                <label for="txtConfirmarPass">Reiniciar Contraseña</label>
                                <div class="form-group">
                                    <!-- Reiniciar Contraseña -->
                                    <asp:CheckBox ID="cbReinicioContrasena" runat="server" Width="15px"></asp:CheckBox>La nueva contraseña será "Salad123" y se recomienda cambiarla después de iniciar nuevamente.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-6 align-self-center">
                        <asp:HyperLink ID="hplRegresar" class="btn btn-danger btn-block" runat="server" NavigateUrl="~/src/aspx/frmListaUsuarios.aspx">Regresar</asp:HyperLink>
                    </div>
                    <div class="col-6 align-self-center">
                        <asp:Button ID="btnModificar" class="btn btn-success btn-block" runat="server" Text="Modificar Usuario" OnClick="btnModificar_Click"  />
                    </div>
                </div>
            </div>
        </div>
